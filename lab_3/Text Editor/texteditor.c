//x86_64-w64-mingw32-gcc texteditor.c -o texteditor.exe -Wall -mwindows
//Запускать через wine texteditor.exe
#include <windows.h>
#include <commctrl.h>
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case OnMenu2Clicked:
            ...
            break;
        case OnMenu3Clicked:
            MessageBox(hwnd, "A simple text editor\nDeveloper: Hetsunya", "About the program", MB_OK);
            break;
        case ON_CUT:
    ...
    case WM_SIZE:
        {
            ...
            MoveWindow(edit, 15, 15, cxClient - 30, cyClient - 50, TRUE);
            MoveWindow(GetDlgItem(hwnd, ID_QUIT), cxClient - 100, cyClient - 30, 80, 25, TRUE);

            // Обновление статус-бара (если он присутствует)
